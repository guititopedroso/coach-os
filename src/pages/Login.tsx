...
export default function Login() {
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-zinc-950 text-white font-sans">
      <form onSubmit={handleLogin} className="w-full max-w-sm p-8 space-y-6 bg-zinc-900/50 border border-zinc-800 rounded-2xl backdrop-blur-xl">
        <div className="space-y-2 text-center">
          <h1 className="text-3xl font-bold tracking-tight">CoachOS</h1>
          <p className="text-zinc-400">Entra na tua conta</p>
        </div>
        ...
        <p className="text-center text-sm text-zinc-500">
          Não tens conta? <Link to="/register" className="text-white hover:underline">Registar</Link>
        </p>
      </form>
    </div>
  )
